...
var UIController = (function() {
    ...
    return {
        ...
        displayMonth: function () {
            ...
            now = new Date();
            // var christmas = new Data(2020, 11, 25);
...
// GLOCAL APP CONTROLLER
var controller = (function (budgetCtrl, UICrtl) {

    var setupEventListeners = function () {

        var DOM = UICrtl.getDOMstrings();  // store the buttons from the UICrtl
    ...
    var updatePercentages = function () {
        ...
        // 2. Read perrcentages from the budget controller
    ...
    var crtlAddItem = function (){
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 2. Add the item do the budget controller
